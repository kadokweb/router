...
<form action="" method="POST">
  ...
  <input type="text" name="email" value="doka@kadok.com.br" />
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => "first_name=Doka&last_name=Silva&email=doka%40kadok.com.br",
...
- [All Contributors](https://github.com/kadokweb/router/contributors) (This Rock)
